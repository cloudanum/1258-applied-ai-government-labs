# Do Now 2.D: Bookmark a Dataset 🎯

**Time:** 5 minutes
**Format:** No sandbox or tooling required, this activity is done mentally (or with nothing more than your browser's bookmark button) and is captured privately in your own notes and bookmarks; share only a one-line theme with the group, on the Mural board or in Zoom chat, if the instructor asks for a roundup.
...
## Study further 📚
- [Data.gov](https://www.data.gov), the U.S. federal open-data catalog, home to hundreds of thousands of agency datasets.
- [Outdoor Air Quality Data, U.S. EPA](https://www.epa.gov/outdoor-air-quality-data), a model dataset landing page with documentation, download formats, and update history.
...
**Solution link in master guide:** `#answer-2-d`
