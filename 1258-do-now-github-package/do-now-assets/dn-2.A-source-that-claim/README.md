# Do Now 2.A: Source That Claim 🎯

**Time:** 5 minutes
**Format:** No sandbox or tooling required, you need only a browser for ordinary web search; verdicts are captured in Zoom chat (or on the Mural board if you are in the room).
...
## Study further 📚
- [Data.gov](https://data.gov/), the U.S. government's open data portal, where dataset claims can be checked against actual files and dictionaries.
- [De-Identification of Personal Information (NISTIR 8053), NIST](https://csrc.nist.gov/publications/detail/nistir/8053/final), the reference for judging whether "no personal information" is actually true of a dataset.
- [FactCheck.org, Annenberg Public Policy Center](https://www.factcheck.org/), a nonpartisan model of claim-by-claim verification with sources attached.

## Common mistake to name ⚠️
Posting a verdict with no URL or no date, "SUPPORTED because I found a blog post" is an opinion, not verification; require one reason, one source, and one date before the verdict counts.

## If finished early ⏩
Take the claim one level deeper: find the baseline period or methodology section behind the number and post whether the comparison was fair, a 40% reduction against a bad baseline is a different claim.

## ⭐ Bonus (optional)
Write one claim of your own about an AI system or dataset at your agency, then grade it against the same standard: what URL and date would a skeptic need, and can you produce them? Post the claim (no sensitive details) and your grade in chat.

**Solution link in master guide:** `#answer-2-a`
