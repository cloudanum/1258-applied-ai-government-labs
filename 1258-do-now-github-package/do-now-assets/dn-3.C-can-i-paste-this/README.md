...
## Goal
Sort eight realistic content stickies (C1–C8) into three paste-decision buckets, **OK**, **Mask first**, or **Never**, for use in an AI tool, and flag the one sticky where you would check agency policy first. You walk away with a fully sorted board plus one comment naming the policy question you would ask.
...
## Run steps 🪜
1. Open the Mural board linked above and read all eight content stickies C1–C8; for each ask three questions: who is in this content, who is it for, and what is its release status?
...
3. Remote? Post all eight calls in Zoom chat, e.g. `C1-OK, C2-Never, C3-Never, C4-Mask...`.
...
5. Compare boards with a neighbor or the room: find one sticky where you disagreed, C3 (the name-free deliberative draft) is the classic split, and listen to the other argument.
...
Marking internal drafts as OK because they contain no names: deliberative status can still make them unsafe to paste.
