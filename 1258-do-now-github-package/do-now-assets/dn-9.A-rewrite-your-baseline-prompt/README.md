...
**Time:** 5 minutes
**Format:** No sandbox or tooling required, this activity is done mentally and captured in your private notes; share only the technique category in Zoom chat or on the Mural board, never the sensitive prompt itself.
...
## Study further 📚
- [What is prompt engineering?, IBM Think](https://www.ibm.com/think/topics/prompt-engineering), concise primer on prompt techniques and why structure matters.
- [Introduction to prompt design, Google Cloud](https://cloud.google.com/vertex-ai/generative-ai/docs/learn/prompts/introduction-prompt-design), official guide to roles, context, and output formatting for generative models.
